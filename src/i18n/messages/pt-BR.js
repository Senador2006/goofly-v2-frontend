...
export default {
  ...
  tdv: {
    ...
    modify_insert_zone: 'Inserir aqui',
    modify_drop_swap: 'Solte para trocar',
    modify_drop_insert: 'Solte para inserir neste dia',
    modify_tap_swap: 'Toque para trocar',
    modify_swap_hint: 'Toque numa parada do roteiro para trocar com a curtida selecionada, ou arraste a curtida até ela',
